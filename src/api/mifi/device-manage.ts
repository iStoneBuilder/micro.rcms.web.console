...
export const getPageRecordList = (
  ...
  return http.request<ResultPage>(
    "get",
    `/test/services/api/device/device-manage/records/page/${curPage}/${pageSize}`,
    {
      params
    }
  );
...
export const importRecords = (data?: Array<any>) => {
  return http.request<ResultData>(
    "post",
    "/test/services/api/device/device-manage/records",
    {
      data
    }
  );
...
export const updateRecord = (id: string, data?: object) => {
  return http.request<ResultData>(
    "put",
    `/test/services/api/device/device-manage/records/${id}`,
    {
      data
    }
  );
...
export const updateRecordGroup = (data?: Array<any>) => {
  return http.request<ResultData>(
    "put",
    `/test/services/api/device/device-manage/records/group`,
    {
      data
    }
  );
