      ...
      children: [
        {
          ...
          component: () =>
            import("@/views/demo/nested/menu1/menu1-1/index.vue"),
          name: "Menu1-1",
          meta: {
          ...
          children: [
            {
              ...
              component: () =>
                import("@/views/demo/nested/menu1/menu1-2/menu1-2-1/index.vue"),
              name: "Menu1-2-1",
              meta: {
            ...
            },
            {
              ...
              component: () =>
                import("@/views/demo/nested/menu1/menu1-2/menu1-2-2/index.vue"),
              name: "Menu1-2-2",
              meta: {
        ...
        },
        {
          ...
          component: () =>
            import("@/views/demo/nested/menu1/menu1-3/index.vue"),
          name: "Menu1-3",
          meta: {
